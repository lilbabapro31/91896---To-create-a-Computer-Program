...
Return.config(font = ("Courier New", 14, "bold"),width = 14, fg= "white", bg= "gold")

#Placement of hire button
Hire = Button(root, text = "HIRE", command="???")
Hire.place(x=125,y=320)
Hire.config(font = ("Courier New", 14, "bold"),width = 14,  fg= "white", bg= "gold")

#Placement of quit button
Quit = Button(root, text = "QUIT", command=quit)
Quit.place(x=515,y=385)
Quit.config(font = ("Courier New", 14, "bold"),width = 8,  fg= "white", bg= "gold")

result_text = tk. StringVar()

#Placement of first name and entry field
first_name = tk.Label(root, text="First Name:")
first_name.place(x=140,y=90)
entry_first_name = tk.Entry(root)
entry_first_name.place(x=265,y=95)
first_name.config(font = ("Courier New", 14), fg= "gold", bg='#1E1E1E')
entry_first_name.config(font = ("Courier New", 14))

#Placement of last name and entry field
last_name = tk.Label(root, text="Last Name:")
last_name.place(x=150,y=150)
entry_last_name = tk.Entry(root)
entry_last_name.place(x=265,y=155)
last_name.config(font = ("Courier New", 14), fg= "gold", bg='#1E1E1E')
entry_last_name.config(font = ("Courier New", 14))

#Placement of receipt number and entry field
receipt = tk.Label(root, text="Receipt #:")
receipt.place(x=150,y=205)
entry_receipt = tk.Entry(root)
entry_receipt.place(x=265,y=210)
receipt.config(font = ("Courier New", 14), fg= "gold", bg='#1E1E1E')
entry_receipt.config(font = ("Courier New", 14))

#Placement of items and combobox
items = tk.Label(root, text="Items:")
items.place(x=110,y=260)
items.config(font = ("Courier New", 14), fg= "gold", bg='#1E1E1E')
...
items_box.config(font = ("Courier New", 14))

#Placement of quantity and entry field
quantity = tk.Label(root, text="Quantity:")
quantity.place(x=320,y=260)
entry_quantity = tk.Entry(root)
entry_quantity.place(x=425,y=260)
quantity.config(font = ("Courier New", 14), fg= "gold", bg='#1E1E1E')
entry_quantity.config(font = ("Courier New", 14), width=10)

#Placement of title
title = tk.Label(root, text = "Welcome to Julie's Party Hire store!")
title.place(x=75,y=25)
title.config(font = ("Courier New", 19, "bold"), fg= "gold", bg='#1E1E1E')
