...
entry_first_name.place(x=165,y=215)
...
last_name.place(x=50,y=270)
entry_last_name = tk.Entry(root)
entry_last_name.place(x=165,y=275)
...
receipt.place(x=50,y=325)
entry_receipt = tk.Entry(root)
entry_receipt.place(x=165,y=330)
receipt.config(font = ("Comic Sans MS", 14), fg= "#454545", bg='lightblue')
entry_receipt.config(font = ("Comic Sans MS", 14))

#Placement of items and combobox
items = tk.Label(root, text="Items:")
items.place(x=50,y=380)
