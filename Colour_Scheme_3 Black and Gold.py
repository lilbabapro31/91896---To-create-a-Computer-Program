...
Return.config(font = ("Comic Sans MS", 14, "bold"),width = 14, fg= "black", bg= "gold")

#Placement of hire button
Hire = Button(root, text = "HIRE", command="???")
Hire.place(x=125,y=320)
Hire.config(font = ("Comic Sans MS", 14, "bold"),width = 14,  fg= "black", bg= "gold")

#Placement of quit button
Quit = Button(root, text = "QUIT", command=quit)
Quit.place(x=515,y=385)
Quit.config(font = ("Comic Sans MS", 14, "bold"),width = 8,  fg= "black", bg= "gold")
...
first_name.config(font = ("Comic Sans MS", 14), fg= "gold", bg='#1E1E1E')
...
last_name.config(font = ("Comic Sans MS", 14), fg= "gold", bg='#1E1E1E')
...
receipt.config(font = ("Comic Sans MS", 14), fg= "gold", bg='#1E1E1E')
...
items.config(font = ("Comic Sans MS", 14), fg= "gold", bg='#1E1E1E')
...
quantity.config(font = ("Comic Sans MS", 14), fg= "gold", bg='#1E1E1E')
...
title.config(font = ("Comic Sans MS", 19, "bold"), fg= "gold", bg='#1E1E1E')
