...
Hire.config(font = ("Poplar Std", 14),width = 14)
...
first_name.config(font = ("Arial", 14),bg='lightblue')
...
last_name.config(font = ("Arial", 14),bg='lightblue')
...
receipt.config(font = ("Arial", 14),bg='lightblue')
entry_receipt.config(font = ("Arial", 14))

#Placement of item combobox
items_box = ttk.Combobox(root, values=["Balloons","Party Hat","Confetti","Party popper","Plates","Forks","Cups"], width=15)
...
entry_quantity.place(x=415,y=260)
quantity.config(font = ("Arial", 14),bg='lightblue')
entry_quantity.config(font = ("Arial", 14), width=10)

#Placement of title
title = tk.Label(root, text = "Welcome to Julie's Party Hire store!")
title.place(x=135,y=30)
title.config(font = ("Arial", 17),bg='lightblue')
