...
Return.config(font = ("Comic Sans MS", 14, "bold"),width = 14, fg= "#454545", bg= "#C88AE5")

#Placement of hire button
Hire = Button(root, text = "HIRE", command="???")
Hire.place(x=125,y=320)
Hire.config(font = ("Comic Sans MS", 14, "bold"),width = 14,  fg= "#454545", bg= "#C88AE5")

#Placement of quit button
Quit = Button(root, text = "QUIT", command=quit)
Quit.place(x=515,y=385)
Quit.config(font = ("Comic Sans MS", 14, "bold"),width = 8,  fg= "#454545", bg= "#AA5FCC")
...
first_name.config(font = ("Comic Sans MS", 14), fg= "#454545", bg='#E2A1FF')
...
last_name.config(font = ("Comic Sans MS", 14), fg= "#454545", bg='#E2A1FF')
...
receipt.place(x=158,y=205)
entry_receipt = tk.Entry(root)
entry_receipt.place(x=265,y=210)
receipt.config(font = ("Comic Sans MS", 14), fg= "#454545", bg='#E2A1FF')
entry_receipt.config(font = ("Comic Sans MS", 14))

#Placement of items and combobox
items = tk.Label(root, text="Items:")
items.place(x=115,y=260)
items.config(font = ("Comic Sans MS", 14), fg= "#454545", bg='#E2A1FF')
...
quantity.config(font = ("Comic Sans MS", 14), fg= "#454545", bg='#E2A1FF')
entry_quantity.config(font = ("Comic Sans MS", 14), width=10)

#Placement of title
title = tk.Label(root, text = "Welcome to Julie's Party Hire store!")
title.place(x=115,y=25)
title.config(font = ("Comic Sans MS", 19, "bold"), fg= "#454545", bg='#E2A1FF')
